...
class AD5933BodeRealtime:
    def __init__(self):
        ...
        self.fig.suptitle("AD5933 - Bode em Tempo Real")
    ...
    def update_plot(self, frame):
        ...
        if self.freq_data:
            ...
            mean_txt = (
                ...
                if self.last_mean_impedance is not None else ""
            )

            self.status_text.set_text(
                f"Última frequência: {self.last_freq_received} Hz | "
                f"Pontos recebidos: {len(freqs)}{mean_txt} | "
    ...
    def start(self):
        ...
        print("\n🚀 BODE EM TEMPO REAL")
        print("📊 Curva bruta + suavizada | Ctrl+C para parar")
        print("-" * 70)
